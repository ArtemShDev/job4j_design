...
select e.id, e.name, e.dep_id, d.id, d.name from departments as d right join emploers as e on d.id = e.dep_id;
select e.id, e.name, e.dep_id, d.id, d.name from emploers as e left join departments as d on d.id = e.dep_id;
